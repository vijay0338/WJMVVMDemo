...
#import "WJRecommendVC.h"
#import "WJRecommendViewModel.h"

@interface WJRecommendVC ()

@property(nonatomic,strong)WJRecommendViewModel *viewModel;
...
- (void)initView{
    ...
    self.navigationController.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName:WJCOLOR(253, 253, 253, 1)};
    ...
    topLabel.textColor      = WJCOLOR(70, 70, 70, 1);
    ...
    botmLabel.textColor      = WJCOLOR(70, 70, 70, 1);
