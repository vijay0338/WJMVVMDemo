...
@interface WJHomeHeadView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
//    [_collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([WJHomeBannerCollectionViewCell class]) bundle:nil] forCellWithReuseIdentifier:@"cell"];
    [_collectionView registerClass:[WJHomeBannerCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
...
{
    WJHomeBannerCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
...
@implementation WJHomeBannerCollectionViewCell
