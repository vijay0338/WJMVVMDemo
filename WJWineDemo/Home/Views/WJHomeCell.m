...
- (void)bind
{
    ...
    [self.managerView.addSubject subscribeNext:^(id x) {
        ...
        if(!self.isSearch)
        {
            [WJTools beginAddAnimationWithImageView:self.wtkImageView animationTime:0.55 startPoint:CGPointZero endPoint:CGPointZero];
        }
    }];
}
...
- (void)configView
{
    ...
    _wtkTitleLabel.textColor        = WJCOLOR(40, 40, 40, 1);
