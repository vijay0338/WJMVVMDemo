...
@interface WJHomeVC ()<UISearchBarDelegate>
@property(nonatomic,strong)WJHomeViewModel *viewModel;

@property(nonatomic,strong)WJHomeCollectionView *collectionView;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageFromColor:WJCOLOR(255, 255, 255, 0.01)] forBarMetrics:UIBarMetricsDefault];
    ...
    [[WJRequestManager postWithURL:@"http://localhost:7777" withParamater:@{}] subscribeNext:^(id x) {
        NSLog(@"%@",x);
    }];
}
...
//            self.searchBar.wtk_bgColor = WJCOLOR(240, 240, 240, 0.5);
        }
        else
        {
...
//            self.searchBar.wtk_bgColor = WJCOLOR(160, 160, 160, 0.5);
        }
        if (y < 0)
        {
...
//            [self.navigationController setNavigationBarHidden:NO animated:YES];
            ...
            {
                NSLog(@"11111");
                [self.navigationController.navigationBar setBackgroundImage:[UIImage imageFromColor:WJCOLOR(255, 255, 255, a)] forBarMetrics:UIBarMetricsDefault];
            }
            if (a < 0.5)
            {
                NSLog(@"22222");
...
- (WJHomeCollectionView *)collectionView{
    if (!_collectionView)
    {
        UICollectionViewFlowLayout *layout = [[UICollectionViewFlowLayout alloc]init];
        _collectionView = [[WJHomeCollectionView alloc]initWithFrame:CGRectMake(0, 0, kWidth, kHeight - 49) collectionViewLayout:layout];
